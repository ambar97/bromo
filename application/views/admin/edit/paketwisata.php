           ...
           <div class="card-body">
             <form action="<?php echo base_url('admin/PaketWisata/prosesEditPaket') ?>" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group col-lg-6">
                 ...
                 <textarea data-toggle="quill" data-quill-placeholder="" class="form-control" name="Keterangan" rows="8" cols="80"><?php echo $p->keterangan; ?></textarea>
               </div>
               <div class="form-group col-lg-6">
               ...
               <div class="col-lg-6">
                 ...
                 <textarea data-toggle="quill" data-quill-placeholder="" class="form-control" name="include" rows="8" cols="80"><?php echo $p->include; ?></textarea>
               </div>
               <div class="col-lg-6">
                 <label class="form-control-label" for="exampleFormControlInput1">Exclude</label>
                 <textarea data-toggle="quill" data-quill-placeholder="" class="form-control" name="exclude" rows="8" cols="80"><?php echo $p->exclude; ?></textarea>
               </div>
               </div
